  ...
  gradient5.append("svg:stop")
   ...
   gradient5.append("svg:stop")
    ...
    .style("fill", function(d) {
      if (d.borough_code < 2 ){return "url(#gradient1)"} ///Brooklyn
      // else if (d.borough_code < 3 ){return "url(#gradient2)";} // Bronx
      // else if (d.borough_code < 4 ){return "url(#gradient3)";} // Manhattan
